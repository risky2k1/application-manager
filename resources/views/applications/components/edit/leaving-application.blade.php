                    ...
                    <tr data-repeater-item>
                        <td>
                            <select class="form-select @error('start_shift') is-invalid @enderror"
                                ...
                                @foreach(config('application-manager.application.shift') as $shift)
                                    <option value="{{$shift}}" @selected($dayOff->start_shift == $shift)>{{$shift}}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            >
                                <option value="">-- --</option>
                                @foreach(config('application-manager.application.shift') as $shift)
                                    <option value="{{$shift}}" @selected($dayOff->end_shift == $shift)>{{$shift}}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <!--end::Label-->
        <!--begin::Input-->
        <textarea name="description" id="description" cols="30" rows="10" class="form-control mb-3 mb-lg-0 @error('phone') is-invalid @enderror" required>{{$application->description}}</textarea>
        <!--end::Input-->
...
<div class="row">
    <div class="col-sm-12">
        ...
        <!--end::Label-->
        <!--begin::Input-->
        <input type="file" name="attached_files" id="attached_files" value="{{$application->attached_files}}" class="form-control mb-3 mb-lg-0 @error('attached_files') is-invalid @enderror">
        <!--end::Input-->
